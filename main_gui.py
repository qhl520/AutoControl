...
class AutoControlApp:
    ...
    def create_sidebar(self):
        ...
        # 显式指定 master，防止变量丢失
        self.var_input = tk.StringVar(master=self.left_panel, value="step")
    ...
    def run_design(self):
        ...
        try:
            ...
            if ts <= 1e-6: raise ValueError("调节时间 Ts 太小 (必须 > 1e-6s)")
            ...
            if in_type == 'step':
                ...
                final_error = abs(target_val - y_data[-1])
